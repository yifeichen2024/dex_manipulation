...
from mujoco_playground._src.manipulation.leap_hand import rotate_z_fc as leap_rotate_z_fc
_envs = {
    ...
    "CubeRotateZAxisFC": leap_rotate_z_fc.CubeRotateZAxisFC
}
